<script>
	...
	//this function will be called before the DOM component is updated
	beforeUpdate(() => {
		if(div) {
	...
	//this function will be called after the DOM component is updated
	afterUpdate(() => {
		if(autoscroll) {
...
<div class="container">
	<div class="phone">
		<!-- bind:this is a special syntax used to bind variable to DOM elment, like reef in React js -->
